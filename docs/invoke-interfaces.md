...
| tags         | `Vec<i32>` | いいえ | 検索対象のタグ ID の配列 |
...
| tags         | `Vec<i32>` | いいえ | 付与するタグ ID の配列     |
...
| folder_id  | i32                    | フォルダ ID    |
| updated_at | String                 | 最終更新日時   |
| tags       | `Option<Vec<TagInfo>>` | タグ情報の配列 |
...
| ---------- | ------------- | -------------------------- |
| title      | String        | メモのタイトル             |
| folder_id  | `Option<i32>` | フォルダ ID                |
| content    | String        | メモの Markdown コンテンツ |
| tags       | `Vec<i32>`    | 付与するタグ ID の配列     |
...
| folder_id  | `Option<i32>`      | 新しいフォルダ ID                |
| content    | `Option<String>`   | 新しいメモの Markdown コンテンツ |
| tags       | `Option<Vec<i32>>` | 新しく付与するタグ ID の配列     |
